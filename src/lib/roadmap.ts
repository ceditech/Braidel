...
export const ROADMAP: RoadmapGroup[] = [
  ...
  },
  {
    ...
    items: [
      { title: "GET/POST /api/opportunities", status: "pending", priority: "high", phase: 1 },
      { title: "GET /api/braiders (search)", status: "pending", priority: "high", phase: 1 },
      { title: "POST /api/applications", status: "pending", priority: "high", phase: 1 },
      { title: "GET/POST /api/messages", status: "pending", priority: "high", phase: 1 },
      { title: "POST /api/ratings", status: "pending", priority: "medium", phase: 1 },
    ],
  },
];
