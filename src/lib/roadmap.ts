...
export const ROADMAP: RoadmapGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Wire dashboards to DB", status: "in_progress", priority: "high", phase: 1 },
      { title: "Write routes: applications, messages, ratings", status: "in_progress", priority: "high", phase: 1 },
    ],
  },
];
