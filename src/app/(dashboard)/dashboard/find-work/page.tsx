...
const TYPES = ["Any type", "Part-time", "Full-time", "Single event"];
...
export default function FindWorkPage() {
  ...
  return (
    <>
      <Topbar title="Find work" subtitle={`${results.length} opportunities within 10 miles`} />
              ...
              <Card key={j.id} padded>
                <div style={{ display: "flex", gap: 14 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 }}>
                      <div>
                        <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 17, color: "var(--charcoal-900)" }}>{j.title}</div>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: 14, borderTop: "1px solid var(--border-subtle)" }}>
                  <div style={{ display: "flex", gap: 14, fontSize: 13, color: "var(--text-muted)", alignItems: "center", flexWrap: "wrap" }}>
                    ...
                    <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}><PinIcon /> {j.distance}</span>
                    <span>{j.posted}</span>
                  </div>
