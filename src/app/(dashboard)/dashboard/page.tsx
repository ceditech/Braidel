...
const TONES = [["#E8C9A8","#C98A5A"],["#E3CFA6","#C2922F"],["#E9B79A","#C75D3F"]];

function SalonPhoto({ seed = 0 }: { seed?: number }) {
  const [a, b] = TONES[seed % TONES.length];
  return (
    <div style={{ width: 46, height: 46, borderRadius: 12, overflow: "hidden", flexShrink: 0,
      background: `linear-gradient(135deg, ${a}, ${b})`, display: "grid", placeItems: "center" }}>
      <svg width="22" height="22" viewBox="0 0 48 48" fill="none" style={{ opacity: .4 }}>
