...
export default function BraiderProfilePage() {
  ...
  const braider = BRAIDERS.find((b) => b.id === params.id);
          ...
          {tab === "about" && (
            <div style={{ marginTop: 22, maxWidth: 580 }}>
              <p style={{ fontSize: 16, lineHeight: 1.7, color: "var(--text-body)" }}>
                {braider.city.split(",")[0]}-based braider specializing in {braider.specs[0].toLowerCase()} and
                protective styles that guard your edges and last. Gentle, scalp-first technique and a calm studio —
                kids and first-timers welcome.
              </p>
